    ...
    if (saved) {
        ...
        const initialProducts = storeType === 'hogar' ? [
        ...
        ] : [
            {
                ...
                sold: false,
                discount: 0,
                description: "Remera 100% algodón con divertido estampado de dinosaurio. Suave, fresca y resistente al lavado. Talles del 2 al 12. 🦕",
                maxInstallments: 0,
                createdAt: new Date().toISOString()
            },
            {
                ...
                sold: false,
                discount: 0,
                description: "Pantalón de algodón suave con estampado de estrellitas brillantes. Cintura elástica para mayor comodidad y libertad de movimiento. Talles del 2 al 10. ⭐",
                maxInstallments: 0,
                createdAt: new Date().toISOString()
            },
            {
                ...
                sold: false,
                discount: 0,
                description: "Conjunto de remera + pantalón con diseño de unicornio mágico. Tela suave hipoalergénica, ideal para el día a día y el juego. Talles del 2 al 8. 🦄",
                maxInstallments: 0,
                createdAt: new Date().toISOString()
            },
            {
                ...
                sold: false,
                discount: 0,
                description: "Gorro tejido con adorable diseño de oso, abriga y enamora. Tejido suave y elástico, talle único adaptable para niños de 1 a 6 años. 🐻",
                maxInstallments: 0,
                createdAt: new Date().toISOString()
            },
            {
                ...
                sold: false,
                discount: 0,
                description: "Remera 100% algodón con estampado de superhéroe. ¡Para el pequeño valiente de la casa! Resistente, cómoda y con colores vibrantes. Talles del 2 al 12. 🦸",
                maxInstallments: 0,
                createdAt: new Date().toISOString()
            },
            {
                ...
                sold: false,
                discount: 0,
                description: "Mochila de tela resistente con diseño de princesa. Perfecta para el jardín, paseos o la escuela. Incluye bolsillo frontal y tirantes ajustables. 👑",
                maxInstallments: 0,
                createdAt: new Date().toISOString()
            }
        ];
